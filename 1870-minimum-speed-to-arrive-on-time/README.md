...
<p><l-core class="">Return </l-core><em><l-core class="">the </l-core><strong><l-core class="">minimum positive integer</l-core></strong><l-core class=""> speed </l-core><strong><l-core class="">(in kilometers per hour)</l-core></strong><l-core class=""> that all the trains must travel at for you to reach the office on time, or</l-core> </em><code>-1</code><em> if it is impossible to be on time</em>.</p>
